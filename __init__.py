...
CLIPPER_SYSTEM_PROMPT = (
    ...
    "Always write the output in English (except the 'language' code field). All natural-language "
    "fields must be in English. The 'language' field must be the detected language of the provided "
    "subtitle blocks."
)
...
CLIPPER_USER_PROMPT_TEMPLATE = (
    ...
    "Important: produce English output text.\n\n"
    ...
    "9) OUTPUT LANGUAGE: Write title, headline, summary, why_it_matters, and keywords in ENGLISH, "
    "even if the subtitle blocks are in another language.\n"
    "10) The JSON field \"language\" must be the language code of the subtitle blocks (source "
    "language), not \"en\" unless the subtitles are English.\n"
    "11) Do not translate or rewrite subtitle blocks; only produce an English summary of them.\n\n"
    "QUALITY GOAL\n"
